...
class Race {
    ...
    constructor(type, colorIndex, population, ageLimit) {
        ...
        this.ownMap = {};
        this.mapCoords = Array(1000000).fill(null);
        this.neibours = [];
    }
    ...
    setOwnMapPoint(x, y, value) {
        this.ownMap[y + '.' + x] = value;
    }

    setNeibour(x, y, value) {
        this.neibours[x + '.' + y] = value;
    }

    getCoordinatesToCheck() {
        if (Object.keys(this.neibours).length) {
